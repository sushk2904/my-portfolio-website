...
// SVG Icon Components (monochrome, 32x32)
const PythonIcon = () => (
...
const PandasIcon = () => (
    <svg viewBox="0 0 32 32" className="w-8 h-8" fill="currentColor">
        <rect x="12" y="4" width="2.5" height="6" /><rect x="12" y="13" width="2.5" height="10" /><rect x="12" y="26" width="2.5" height="2" /><rect x="17.5" y="10" width="2.5" height="5" /><rect x="17.5" y="18" width="2.5" height="10" />
    </svg>
);

const PyTorchIcon = () => (
    <svg viewBox="0 0 32 32" className="w-8 h-8" fill="currentColor">
        <path d="M16 6c-.4 0-.7 0-1 0v2c3.3.1 6 2.7 6 6s-2.7 5.9-6 6v2c4.4-.1 8-3.6 8-8s-3.6-7.9-8-8zm0 10c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" /><path d="M11 14c0-2.8 2.2-5 5-5V7c-3.9 0-7 3.1-7 7s3.1 7 7 7v-2c-2.8 0-5-2.2-5-5z" /><circle cx="16" cy="3" r="1.5" />
    </svg>
);
...
const LinuxIcon = () => (
    <svg viewBox="0 0 32 32" className="w-8 h-8" fill="currentColor">
        <circle cx="13" cy="11" r="1" /><circle cx="19" cy="11" r="1" /><path d="M16 3C11 3 8 7 8 11c0 2 0 3 1 5 0 1 0 2-1 3l-1 1c-1 1-1 2 0 3 0 1 1 1 2 1h3c1 2 3 3 4 3s3-1 4-3h3c1 0 2 0 2-1 1-1 1-2 0-3l-1-1c-1-1-1-2-1-3 1-2 1-3 1-5 0-4-3-8-8-8zm0 2c4 0 6 3 6 6 0 2 0 3-1 4-1 2 0 4 1 5l1 1-1 1h-4c0-1-1-2-2-2s-2 1-2 2H10l-1-1 1-1c1-1 2-3 1-5-1-1-1-2-1-4 0-3 2-6 6-6z" />
    </svg>
);
...
const ReactIcon = () => (
    <svg viewBox="0 0 32 32" className="w-8 h-8" fill="currentColor">
        <circle cx="16" cy="16" r="2.3" /><path d="M16 11.2c6.4 0 11.7 1.5 11.7 3.3s-5.2 3.3-11.7 3.3S4.3 16.3 4.3 14.5s5.2-3.3 11.7-3.3zm-9.5 7c3.2 5.5 7.8 9.2 10.3 8.3s2.1-6-.9-11.5c-3.1-5.5-7.8-9.2-10.3-8.3S3.5 12.7 6.5 18.2zm0-7.4c-3.1 5.5-3.4 10.6-.9 11.5s7.1-2.8 10.3-8.3c3.1-5.5 3.4-10.6.9-11.5s-7.2 2.8-10.3 8.3z" />
    </svg>
);
...
export default function TechStack() {
    ...
    return (
        <section
            ref={sectionRef}
            className="py-40 bg-luxury-black px-6 md:px-12 border-t border-white/5"
        >
            <div className="max-w-7xl mx-auto">
                <motion.h2
                    ...
                    className="text-4xl md:text-5xl font-semibold text-white mb-24 tracking-tight"
                >
                    Technology Stack
                </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {technologies.map(({ name, Icon }, index) => (
                        <motion.div
                            ...
                            className="group flex items-center gap-5 p-8 bg-[#111111] rounded-2xl border border-white/10 hover:bg-[#151515] hover:-translate-y-1 transition-all duration-250 cursor-default"
                        >
                            <div className="text-gray-400 group-hover:text-gray-200 transition-colors duration-250">
                                <Icon />
                            </div>
